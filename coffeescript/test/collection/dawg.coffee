...
programming_languages = yaml.safeLoad fs.readFileSync("#{__dirname}/../../../shared/resources/programming-languages.yaml", 'utf8')
...
module.exports =
  ...
  'A DAWG should accept all and only its complete terms': (test) ->
    ...
    test.strictEqual dawg.accepts('foobarbaz'), false, 'Expected dawg to reject "foobarbaz", since it is not a programming language'
